...
/// SelectedActiveSymbol Widget class
class SelectedActiveSymbolWidget extends StatefulWidget {
  /// SelectedActiveSymbol Widget Constructor
  ...
  Widget build(BuildContext context) => Column(
        children: <Widget>[
          BlocBuilder<ActiveSymbolsCubit, ActiveSymbolsState>(
              ...
              builder:
                  (BuildContext context, ActiveSymbolsState activeSymbolState) {
          ...
          BlocBuilder<TickStreamCubit, TicksStreamState>(
              ...
              builder: (BuildContext context, TicksStreamState tickState) {
